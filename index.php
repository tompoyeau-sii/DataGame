...
<body style="background-image: url('./assets/bg.png'); background-repeat: no-repeat; background-size: cover;">
  <div class="container bg-white p-3 mb-5 rounded-3">
    <div class="row">
        ...
        <div class="row">
          <form action="" method="POST">
            ...
            <div class="col-sm-6 col-md-5 col-lg-4">
              <input pattern="[a-zA-ZÀ-ÿ0-9 -]+" title="Seul le caractère suivant est autorisé pour ce champs: -" type="prenom" required class="form-control mt-2" id="prenom" name="prenom" placeholder="Prenom">
            </div>

            <div class="g-recaptcha pt-2" data-sitekey="6LfHbJ8jAAAAAJ66fXodkjhuhRqTCTqn9THitAa7"></div>

            <div class="col-sm-4">
              <input class="btn btn-primary mt-2" type="submit" name="next" value="Démarrer le test">
            </div>
